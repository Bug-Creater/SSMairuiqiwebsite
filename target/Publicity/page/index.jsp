    ...
    <div class="container content-lg">
        <div class="row text-center margin-b-40">
            <div class="col-sm-6 col-sm-offset-3">
                <h2>秋季新款</h2>
                <p>广东艾瑞琪贸易有限公司，是一家集服装设计、生产、销售于一体的贸易有限公司。公司主打品牌——“艾瑞琪”(AIRIQI)，是为注重生活品质与细节、有精致化生活倾向的新都市女性打造的快时尚品牌。</p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 sm-margin-b-50">
                ...
                <p>“艾瑞琪”（AIRIQI），是为注重生活品质与细节、有精致化生活倾向的新都市女性打造的快时尚品牌。</p>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                ...
                <p>艾瑞琪拥有来自日、韩最前沿设计团队和国际化的运营团队，凭借强大的设计力量和现代化的管理理念，立志打造国内引领潮流的快速时尚品牌。</p>
                <a class="link" href="#">Read More</a>
            </div>
            <!-- End Latest Products -->
                    ...
                    <div class="work-popup-overlay">
                        <div class="work-popup-content">
                            ...
                            <div class="margin-b-30">
                                <h3 class="margin-b-5">艾瑞琪品牌故事</h3>
                                <span>艾瑞琪 &amp; 贸易有限公司</span>
                            </div>
                            <div class="row">
                                <div class="col-sm-8 work-popup-content-divider sm-margin-b-20">
                                    <div class="margin-t-10 sm-margin-t-0">
                                        <p>是一家集服装设计、生产、销售于一体的贸易有限公司。公司主打品牌——“艾瑞琪”(AIRIQI)，是为注重生活品质与细节、有精致化生活倾向的新都市女性打造的快时尚品牌。</p>
                                        <p>艾瑞琪, 立志打造国内潮流的快速时尚品牌。</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">艾瑞琪服装贸易公司</h4>
                </div>
                <div class="modal-body">
                   <span>这是我们的最新产品，去享受艾瑞琪带来的时尚生活</span>
                </div>
